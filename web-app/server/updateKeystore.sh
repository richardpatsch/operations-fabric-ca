...
ORG_1_PATH_TO_KEYSTORE="/usr/src/crypto/org1/admin/msp/keystore"
ORG_2_PATH_TO_KEYSTORE="/usr/src/crypto/org2/admin/msp/keystore"

ORG_1_KEYSTORE=$(ls $ORG_1_PATH_TO_KEYSTORE)
ORG_2_KEYSTORE=$(ls $ORG_2_PATH_TO_KEYSTORE)
...
sed -i -e "s|/usr/src/crypto/org1/admin/msp/keystore/.*|$UPDATED_KEYSTORE_ORG_1|g" connection.yaml

echo 'updating connection.yaml Org2 adminPrivateKey path with' ${UPDATED_KEYSTORE_ORG_2}

sed -i -e "s|/usr/src/crypto/org2/admin/msp/keystore/.*|$UPDATED_KEYSTORE_ORG_2|g" connection.yaml
