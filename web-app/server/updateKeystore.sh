...
ORG_1_KEYSTORE=$(ls ../crypto/org1/admin/msp/keystore)
ORG_2_KEYSTORE=$(ls ../crypto/org2/admin/msp/keystore)

ORG_1_PATH_TO_KEYSTORE="admin/msp/keystore/"
ORG_2_PATH_TO_KEYSTORE="admin/msp/keystore/"
